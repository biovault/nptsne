...
with open(os.path.join(os.path.dirname(__file__), "src", "nptsne", "_version.txt")) as fp:
...
setup(
    ...
    description=("The nptsne package is designed to "
                 "export a number of python classes that wrap tSNE."),
    ...
    # TODO add test_require for the behave tests see
    # https://stackoverflow.com/questions/21698004/python-behave-integration-in-setuptools-setup-py
    classifiers=[

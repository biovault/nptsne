...
def main():
  ...
  model_gui: AnalysisTreeGui = None
  ...
  def remove_analysis(id: int) -> List[int]:
      ...
      for id in removed_ids:
          analysis_event_queue.put({"event": AnalysisEvent.REMOVED, "id": id})
  ...
  def add_analysis(parent_analysis: hsne_analysis.Analysis, selected_indexes: np.ndarray) -> None:
      ...
      analysis_guis[new_analysis.id] = AnalysisGui(
          data,
          new_analysis,
          add_analysis,
          remove_analysis,

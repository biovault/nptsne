...
from PyQt5.QtWidgets import (QWidget, QFormLayout, 
    QVBoxLayout, QComboBox, QLabel, QPushButton,
...
class MetaDataViewer(QWidget):
    """This is the QT Gui that can be used to manipulate
        ...
        Assumes layout of the meta-data csv is as follows:
    ...
    def __init__(self, embedding_gui, width=2, height=2):
    ...
    def on_class(self, index):
        ...
        # self.meta_group.clear()
        self.labels = list(self.label_series.unique())
        self.labels.sort()
        self.__fill_table()
        # some label columns are not strings - whodathunkit!
        self.string_labels = list(map(str, self.labels))
        # self.meta_group.addItems(self.string_labels)

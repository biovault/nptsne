...
class ModelController():
    ...
    def queue_new_analysis(self, analysis):
    ...
    def analysis_stopped(self, analysis, image_buf):
    ...
    def tree_click(self, analysis_id):
    ...
    def tree_del(self, analysis_ids):
    ...
    def __set_labels_and_color_norm(self, label_file):
        ...
        print(f'Making colormap for numlabels: {num_labels}\

...
PYBIND11_MODULE(_nptsne, m)
{
    ...
    textureTsneExtended.def("init_with_transition_matrix_list_and_embedding",
                            &TextureTsneExtended::init_with_transition_matrix_list_and_embedding,
                            R"pbdoc(                        
    ...
    textureTsneExtended.def("init_with_transition_matrix_dict_and_embedding",
                            &TextureTsneExtended::init_with_transition_matrix_dict_and_embedding,
                            R"pbdoc(                        
            Initialize the transform with a transistion matrix and an initial embedding.
